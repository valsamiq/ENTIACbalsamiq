...
public class EntiaCbalsamiqApp {

    private static final Logger log = LoggerFactory.getLogger(EntiaCbalsamiqApp.class);

    private final Environment env;

    public EntiaCbalsamiqApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes ENTIACbalsamiq.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(EntiaCbalsamiqApp.class);
